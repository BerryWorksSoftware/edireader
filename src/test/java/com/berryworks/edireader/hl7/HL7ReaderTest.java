...
public class HL7ReaderTest {
    ...
    @Test
    public void canParsePathologicalCase4() throws EDISyntaxException, IOException, TransformerException {
        StringReader stringReader = new StringReader("""
                MSH|^~\\&|REGISTRATION|GENERAL_HOSPITAL|EHR|GENERAL_HOSPITAL|20260905083000||ADT^A01^ADT_A01|MSG00001|P|2.7
                ZXX|A~B^^E~G|
                """);
    ...
    @Test
    public void canParsePathologicalCase5() throws EDISyntaxException, IOException, TransformerException {
        StringReader stringReader = new StringReader("""
                MSH|^~\\&|REGISTRATION|GENERAL_HOSPITAL|EHR|GENERAL_HOSPITAL|20260905083000||ADT^A01^ADT_A01|MSG00001|P|2.7
                ZXX|A~B^^E^~G|
                """);
    ...
    @Test
    public void canParsePathologicalCase7() throws EDISyntaxException, IOException, TransformerException {
        StringReader stringReader = new StringReader("""
                MSH|^~\\&|REGISTRATION|GENERAL_HOSPITAL|EHR|GENERAL_HOSPITAL|20260905083000||ADT^A01^ADT_A01|MSG00001|P|2.7
                ZXX|A~B^C&D^E&F~G^H&I&J|
                """);
