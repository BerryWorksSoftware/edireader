...
public interface ErrorMessages {
    ...
    public static final String XML_INSTEAD_OF_EDI = "Encountered XML when expecting EDI";
    public static final String SE_MISSING = "Transaction must be terminated with an SE segment";
    ...
    public static final String TRADACOMS_MISSING_STX = "TRADACOMS interchange must begin with STX";
    public static final String SEQUENCE_MHD = "Message sequence error in MHD segment";
    public static final String COUNT_MTR = "Segment count error in MTR segment";
    public static final String COUNT_END = "Message count error in END segment";
    public static final String CONTROL_NUMBER_RSG = "Sender's transmission reference error in RSG reconciliation segment";
    public static final String RECIPIENT_RSG = "Recipient error in RSG reconciliation segment";
}
